...
$("#img_slider").gallerySplash();
    ...
    $('.zoomSp').hover(function(){ $(this).stop().fadeTo(500, 0.5)}, function(){$(this).stop().fadeTo(500, 0)})    
     ...
     $('._list1 > li > a').hover(
     function(){ 
        $(this).stop(true).animate({'margin-left':'25px',color:'#31A1FF'},300);
        },
      function(){
     ...
     function(){ 
        $(this).stop(true).animate({'margin-left':'10px',color:'#31A1FF'},300);
        },
      function(){
	...
	nav.navs({
          ...
          //  defHash: '#!/pageGallery',
             hoverIn:function(li){
                ...
                $(".mText", li).stop(true).animate({color:'#31A1FF'},500,'easeOutExpo');
